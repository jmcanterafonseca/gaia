...
(function() {
  ...
  var DATASTORE_NAME = 'Master_Contacts';
  ...
  var INITIALIZE_EVENT = 'contacts_ds_init';
  ...
  /**
   *  Allows to obtain a Contact by uid
   *
   *
   */
  ...
  /**
   *  Allows to get contact information by tel number (short or long)
  ...
  /**
   *  Allows to search for contacts by different criteria.
  ...
  /**
   *  Allows to obtain how many records contain the Database
   *
   */
