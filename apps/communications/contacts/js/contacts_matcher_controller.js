...
if (!contacts.MatcherController) {
  contacts.MatcherController = (function() {
    ...
    function start(cid) {
      ...
      var callbacks = {
        onmatch: function(results) {
          ...
          matchings = results;
          LazyLoader.load('/contacts/js/contacts_matcher_ui.js',
                          function done() {
            contacts.MatcherUI.load(masterContact, results, function() {
