...
*/
var GmailConnector = (function GmailConnector(mozContacts) {
  ...
  var listDeviceContacts = function listDeviceContacts(callbacks) {
    ...
    var req = mozContacts.find(filterOptions);
  ...
  var cleanContacts = function cleanContacts(contactsList, mode, cb) {
    var cleaner = new window.ContactsCleaner(contactsList, mozContacts);
...
})(parent.location.origin === window.location.origin && navigator.mozContacts ||
   parent.navigator.mozContacts);
